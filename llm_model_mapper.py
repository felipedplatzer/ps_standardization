    ...
    def mappings_to_dict_list(self, mapping_batch: ModelMappingBatch) -> List[Dict[str, Any]]:
        ...
        for mapping in mapping_batch.mappings:
            data.append({
                ...
                'model_confidence': mapping.confidence,
            })
...
def main(model_name_target_list: List[str], model_name_source_list: List[str]) -> List[Dict[str, Any]]:
    ...
    Returns:
        List of dictionaries with mapping results containing model_name_source, model_name_target, and model_confidence
    """
    ...
    # Get mapping results
    mapping_results = mapper.mappings_to_dict_list(mapping_batch)
